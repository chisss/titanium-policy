package com.titanium.policy.web.dto.issuance;
 ...
 * 意向单转投保单请求
 * <p>
 * Web 层入参，经 {@code InsuranceWebMapper} 转换为领域命令 {@code ConvertProposalToInsuranceCommand}。
 * </p>
 */
@Schema(description = "意向单转投保单请求")
@Data
